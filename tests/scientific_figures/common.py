...
REQUIRED_MODULES = ("matplotlib", "numpy", "PIL", "pandas", "openpyxl", "skimage", "pypdf")
FIGURE_TEST_DEPENDENCIES_AVAILABLE = all(importlib.util.find_spec(name) is not None for name in REQUIRED_MODULES)
...
@unittest.skipUnless(FIGURE_TEST_DEPENDENCIES_AVAILABLE, "install requirements-figures.txt to run scientific figure tests")
