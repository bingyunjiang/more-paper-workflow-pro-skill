...
def render_visualspec(spec: dict[str, Any], output_dir: Path, spec_path: str = "", script_path: str | None = None) -> dict[str, Any]:
    ...
    metadata = {"Creator": "more-paper-workflow-pro-skill", "Date": None}
    fig.savefig(png, dpi=dpi, bbox_inches=bbox_inches, pad_inches=0, metadata={"Software": "more-paper-workflow-pro-skill"})
    fig.savefig(svg, bbox_inches=bbox_inches, pad_inches=0, metadata=metadata)
    fig.savefig(pdf, bbox_inches=bbox_inches, pad_inches=0, metadata={"Creator": "more-paper-workflow-pro-skill", "Producer": "more-paper-workflow-pro-skill", "CreationDate": None, "ModDate": None})
