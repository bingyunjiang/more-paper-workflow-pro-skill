...
| `deep_read_cards.json/md` | `.json` / `.md` | 🆕 当前小节核心文献深读卡片：claim/method/experiment 摘要、可用边界、读取深度和图文候选 |
...
- 每张卡片至少记录 `claim_summary`、`method_summary`、`experiment_summary`、`usable_for`、`not_usable_for`、`reading_depth`、`source_trace`。
